...
<head>
<meta charset="utf-8">
<title>optical-express-contact-lenses</title>
...
<div class="container home_product_section">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 bgcol1 contact_shop_col2">
		...
		<button type="button" class="btn btn-primary optician_brands_btn">Vision Express contact lenses</button>
		<button type="button" class="btn btn-primary optician_brands_btn">Specsavers</button>
		<button type="button" class="btn btn-primary optician_brands_btn">Boots</button>
		<button type="button" class="btn btn-primary optician_brands_btn">Vision Express</button>
		<button type="button" class="btn btn-primary optician_brands_btn">Optical Express</button>
		...
		<table class="table optician_brands_tbl">
		  ...
		  <tbody>
			<tr>
			  ...
			  <td scope="row">boots near & far</td>
			  <td>Alcon & Ciba Vision</td>
			  <td>Dailies AquaComfort Plus Multifocal</td>
			  <td>Daily | Multifocal</td>
			  <td>$55.89</td>
			  <td><button type="button" class="btn btn-primary btn-sm optican_brand_tbl_btn">View & Buy</button></td>	
