...
<head>
<meta charset="utf-8">
<title>a-guide-to-eye-discharge</title>
...
<div class="container home_product_section">
	...
	<div class="col-sm-9 col-md-9 col-lg-9 bgcol1 contact_shop_col2">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 bgcol1 contact_lense_shop_heading_col">
			<h5 class="contact_lense_shop_heading">Eye discharge</h5>
			
			<h5 class="price_match_heading">What is eye discharge?</h5>
			...
			<h5 class="price_match_heading">What causes eye discharge?</h5>
			...
			<h5 class="price_match_heading">How do I get rid of eye discharge?</h5>
