...
<div class="container glasses_slider_container">
    <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 glasses-slider">
			<a href="#">	
        		<img src="images/Shop/sunglasses/Sunglasses-banner-women-center-2.png"  class="glasses_slider_img">
			</a>	
        </div>
        <!-- Col1 End -->
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 glasses-slider">
			<a href="#">	
        		<img src="images/Shop/sunglasses/Sunglasses-banner-men-left-1.png" class="glasses_slider_img">
			</a>	
        </div>
        <!-- Col2 End -->
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 glasses-slider">
			<a href="#"> 	
        		<img src="images/Shop/sunglasses/sunglassepage-may-40off.jpg" class="glasses_slider_img">
			</a>	
        </div>
        <!-- Col3 End -->
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 glasses_main_heading_col">
				...
				<h5 class="glasses_main_heading">Buy designer sunglasses online cheaper</h5>
...
<div class="container home_product_section">
	<div class="row">
        ...
        <!-- Col01 Start -->
        <div class="col-md-3 col-sm-4 col-lg-3 contact_lense_aside">
			  ...
			  <div class="card">
				...
				<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
					...
					<form method="post" action="">
					 <div class="glasses_bootsnip_checkbox_div">
                     <?php 
						$fetch_query = mysqli_query($conn,"SELECT * FROM gender where id!=0 AND Type='Sunglasses' AND active=1");
			...
			<!-- Category Two Start -->
                ...
                <?php 
						$fetch_query2 = mysqli_query($conn,"SELECT * FROM brand where id!=0 AND Type='Sunglasses' AND active=1");
			...
			<div class="card">
				...
				<div class="bootsnip_brand_checkbox_div">
					<?php 
						$fetch_query3 = mysqli_query($conn,"SELECT * FROM shape where id!=0 AND Type='Sunglasses' AND active=1");
			...
			<div class="card">
				...
				<!-- Frame Color Checkbox Start -->
				 ...
				 <div class="glasses_bootsnip_checkbox_div">
                 <?php 
						$fetch_query4 = mysqli_query($conn,"SELECT * FROM frame_color where id!=0 AND Type='Sunglasses' AND active=1");
		...
		<!-- Category Five Start -->
			...
			<div class="card">
				...
				<!-- Bootsnip Frame Size CheckBox Start -->
					...
					<div class="bootsnip_brand_checkbox_div">
                    <?php 
						$fetch_query5 = mysqli_query($conn,"SELECT * FROM lens_size where id!=0 AND active=1");
						while($row5=mysqli_fetch_array($fetch_query5,MYSQLI_ASSOC)) {
							?> 
					<div class="chiller_bc">
						<input id="<?php echo $row5['LENS_SIZE']; ?>" type="checkbox" name="lensesize[]" class="mycheck_lensesize" value="<?php echo $row5['id']; ?>">
						<label for="<?php echo $row5['LENS_SIZE']; ?>"><?php echo $row5['LENS_SIZE']; ?></label>
						<span></span>
					</div>
                    <?php } ?>
		...
		<!-- Category Six Start -->
			...
			<div class="card">
				...
				<!-- Frame Color Checkbox Start -->
				 ...
				 <div class="glasses_bootsnip_checkbox_div">
                 <?php 
						$fetch_query6 = mysqli_query($conn,"SELECT * FROM lens_colour where id!=0 AND active=1");
						while($row6=mysqli_fetch_array($fetch_query6,MYSQLI_ASSOC)) {
							?> 
						<div class="chiller_cb">
							<input id="<?php echo $row6['image_link']; ?>" type="checkbox" name="lensecolor[]" class="mycheck_lensecolor" value="<?php echo $row6['id']; ?>">
							<label for="<?php echo $row6['image_link']; ?>">
							<img src="images/Shop/glasses/<?php echo $row6['image_link']; ?>">
							</label>
						<span></span>
					  	</div>
					  	<?php } ?>
		...
		<!-- Category Seven Start -->
			...
			<div class="card">
				...
				<!-- Frame Color Checkbox Start -->
					<form method="post" action="">
					 <?php 
						$fetch_query7 = mysqli_query($conn,"SELECT * FROM material where id!=0 AND Type='Sunglasses' AND active=1");
						while($row7=mysqli_fetch_array($fetch_query7,MYSQLI_ASSOC)) {
							?>
                     <div class="frame_checkbox_div">
                     
						<div class="chiller_fc">
						<input id="<?php echo $row7['Material']; ?>" type="checkbox" name="material[]" class="mycheck_material" value="<?php echo $row7['id']; ?>">
						<label for="<?php echo $row7['Material']; ?>">
						<?php echo $row7['Material']; ?>
						</label>
						<span></span>
					  </div>
...
//CheckBox Search Material
	$(document).on("change", ".mycheck_material", function (e) {
		 e.preventDefault();
		$.post('glasses_search2.php',$('form').serialize(),function(data){
     $('#result').html(data);
		})
		e.preventDefault();
	});
	...
	//CheckBox Search Lense Color
	$(document).on("change", ".mycheck_lensecolor", function (e) {
		 e.preventDefault();
		$.post('glasses_search2.php',$('form').serialize(),function(data){
     $('#result').html(data);
		})
	...
	//CheckBox Search Lense Size
	$(document).on("change", ".mycheck_lensesize", function (e) {
		 e.preventDefault();
		$.post('glasses_search2.php',$('form').serialize(),function(data){
     $('#result').html(data);
		})
