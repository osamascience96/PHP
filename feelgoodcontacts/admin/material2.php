...
<html lang="en">
<head>
<title>Sunglasses | Material</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="sunglasses.php" title="Sunglasses" class="tip-bottom"><i class="icon-home"></i>Sunglasses</a> <a href="#" class="current">Material</a> </div>
    <h1>Material</h1>
  </div>
  <div class="container-fluid">
    <hr>
	  <div class="row-fluid">
		 <div class="span6">
			  <button onClick="window.location.href='sunglasses_category_add.php?type=material'" class="btn btn-success add-sglasses-btn"><i class="icon-plus"></i> Add Material</button><br><br>
		</div>
	...
	//3
				$total_pages_sql = "SELECT COUNT(*) FROM material where active=0";
			...
			$total_pages = ceil($total_rows / $no_of_records_per_page);
				...
				$fetch_query = mysqli_query($conn,"SELECT * FROM material where Brands_Name='$my_search' OR Brands_Name LIKE '%$my_search%'  AND active=1");
				}
				else {
				$fetch_query = mysqli_query($conn,"SELECT * FROM material where type='Sunglasses' AND active=1 LIMIT $offset, $no_of_records_per_page");
				}
                ...
                <tr class="odd gradeX">
                  ...
                  <td class="center">
					...
					<button class="btn btn-mini btn-danger add-sglasses-action-btn" onclick="window.location.href='material2.php?delete_sunglasses_material_id=<?php echo $row['id']; ?>'">&nbsp;&nbsp;<i class="icon-trash"></i> &nbsp;</button>
						  </center>
				  </td>
                </tr>
                <?php } ?>
