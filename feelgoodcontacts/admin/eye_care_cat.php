...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="eye_care.php" title="Contact Lense" class="tip-bottom"><i class="icon-home"></i>Eye Care</a> <a href="#" class="current">Eye Care</a> </div>
    <h1>Eye Care</h1>
  </div>
  <div class="container-fluid">
    <hr>
	  <div class="row-fluid">
		 <div class="span6">
			  <button onClick="window.location.href='eye_care_category_add.php?type=types'" class="btn btn-success add-sglasses-btn"><i class="icon-plus"></i> Add Eye Care</button><br><br>
		</div>
	...
	//3
				$total_pages_sql = "SELECT COUNT(*) FROM eye_care where active=0";
			...
			$total_pages = ceil($total_rows / $no_of_records_per_page);
				...
				$fetch_query = mysqli_query($conn,"SELECT * FROM eye_care  where Brands_Name='$my_search' OR Brands_Name LIKE '%$my_search%'  AND active=1");
				}
				else {
				$fetch_query = mysqli_query($conn,"SELECT * FROM eye_care where active=1 LIMIT $offset, $no_of_records_per_page");
				}
                ...
                <tr class="odd gradeX">
				  ...
				  <td style="text-align: center;"><?php echo $row['Eye_Care']; ?></td>
                  ...
                  <td class="center">
					...
					<button class="btn btn-mini btn-danger add-sglasses-action-btn" onclick="window.location.href='eye_care_cat.php?delete_eye_care_type_id=<?php echo $row['id']; ?>'">&nbsp;&nbsp;<i class="icon-trash"></i> &nbsp;</button>
						  </center>
				  </td>
                </tr>
                <?php } ?>
