...
<div id="content">
  ...
  <div class="row-fluid">
	...
	<div class="span8">
		<?php
		$temp_id = $_GET['offers_id'];
		$_SESSION['upd_id']=$temp_id;
		$fetch_query = mysqli_query($conn,"SELECT * FROM offer where id=$temp_id AND active=1");
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="code" class="span11" placeholder="Code" value="<?php echo $rowe['code']; ?>" required/>
              </div>
            </div>
			  <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="moa" class="span11" placeholder="Minimum Order Account" value="<?php echo $rowe['minimum_order_amount']; ?>" required/>
              </div>
            </div>
			  <div class="control-group">
              <label class="control-label"><span class="col-red">*</span> Discout Value :</label>
              <div class="controls">
                <input type="text" name="discount" class="span11" placeholder="Discount Value" value="<?php echo $rowe['discount_value']; ?>" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><span class="col-red">*</span> Valid From :</label>
              <div class="controls">
                <input type="date" name="vf" class="span11" placeholder="Validfrom" value="<?php echo $rowe['valid_from']; ?>" required/>
              </div>
            </div>
			  <div class="control-group">
              <label class="control-label"><span class="col-red">*</span> Valid Till :</label>
              <div class="controls">
                <input type="date" name="vt" class="span11" placeholder="Validtill" value="<?php echo $rowe['valid_upto']; ?>" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><span class="col-red">*</span> Description :</label>
              <div class="controls">
                <input type="text" name="description" class="span11" placeholder="Description" value="<?php echo $rowe['description']; ?>" required/>
              </div>
            </div>
              
            <div class="form-actions">
              <button type="submit" name="update_offers" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
