...
<div id="content" >
    ...
    <div id="breadcrumb"> <a href="users.php"  class="tip-bottom"><i class="icon-home"></i> Users</a> <a href="#" class="current">Add Users </a> </div>
    <h1>Add users <?php if(isset($_GET['product'])  == "contact_lense") { echo "Contact Lense"; } else{} ?></h1>
  </div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions">
              <button type="submit" name="insert_user" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
