              ...
              <tbody>
                <tr class="odd gradeX">
				 ...
				 <tr class="odd gradeX">
                  ...
                  <td><?php
				$temp_product_id2 = $row3['Types_of_Solutions'];										 	
				$fetch_query4 = mysqli_query($conn,"SELECT * FROM types_of_solutions where id=$temp_product_id2 AND active=1");
				while($row4=mysqli_fetch_array($fetch_query4,MYSQLI_ASSOC)) { ?>
				  <option value="<?php echo $row4['Solution_Type']; ?>"><?php echo $row4['Solution_Type']; ?></option>
				<?php } ?></td>
                </tr>
				   <tr class="odd gradeX">
                  <th>Popular Solutions</th>
                  <td><?php
				$temp_product_id3 = $row3['Popular_Solutions'];										 	
				$fetch_query4 = mysqli_query($conn,"SELECT * FROM popular_solutions where id=$temp_product_id3 AND active=1");
				while($row4=mysqli_fetch_array($fetch_query4,MYSQLI_ASSOC)) { ?>
				  <option value="<?php echo $row4['Popular_Solutions']; ?>"><?php echo $row4['Popular_Solutions']; ?></option>
				<?php } ?></td>
                </tr>
              </tbody>
				<?php } ?>
