...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="reglaze.php" class="tip-bottom"><i class="icon-home"></i> Reglaze</a> <a href="#" class="current">Update Reglaze </a> </div>
    <h1>Update Reglaze <?php if(isset($_GET['product'])  == "contact_lense") { echo "Contact Lense"; } else{} ?></h1>
  </div>
  ...
  <div class="row-fluid">
	...
	<div class="span8">
		<?php
		$temp_id = $_GET['reglaze_id'];
		$_SESSION['upd_id']=$temp_id;
		$fetch_query = mysqli_query($conn,"SELECT * FROM reglaze where id=$temp_id");
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
			  ...
			  <img src="../images/Reglaze/<?php echo $row['image']; ?>" width="200px" height="150px" />
              <div class="controls" >
            ...
            <div class="form-actions">
              <button type="submit" name="update_reglaze" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
