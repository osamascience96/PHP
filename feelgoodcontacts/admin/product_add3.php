...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="eye_care.php" title="Go to Eye Care" class="tip-bottom"><i class="icon-home"></i> Eye Care</a> <a href="#" class="current">Add Product Eye Care</a> </div>
    <h1>Add Product Eye Care <?php if(isset($_GET['product'])  == "contact_lense") { echo "Contact Lense"; } else{} ?></h1>
  </div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
			 ...
			 <div class="control-group">
              ...
              <div class="controls">
				...
				<option value="none">Select Eye Care</option>
				<?php
            ...
            <div class="form-actions">
              <button type="submit" name="insert_eye_care" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
