...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="sunglasses.php" title="Go to Sunglasses" class="tip-bottom"><i class="icon-home"></i> Sunglasses</a> <a href="#" class="current">Product View </a> </div>
		...
		<div class="row-fluid">
          ...
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="submit" name="update_size_description2" class="btn btn-success bttn">Save</button>
            </div>
          </form>
						<?php } ?>
        </div>
              ...
              <tbody>
                ...
                <tr>
					...
					<input type="hidden" name="prod_id" value="<?php echo $row['id']; ?>" />
						...
						<td><button type="submit" name="sunglasses_variant_delete" class="btn btn-danger btn-mini"><i class="icon-trash"></i></a></button></td>
						<?php } ?>
					</form>
                </tr>
				<?php } ?>
				...
				<hr>
					...
					<div class="span12" style="margin-left:0px;">
						...
						<?php
							...
							$fetch_query00 = mysqli_query($conn,"SELECT * FROM frame_color where Type='Sunglasses' AND active=1 AND id=$temp_color_id");
						while($row00=mysqli_fetch_array($fetch_query00,MYSQLI_ASSOC)) {
						...
						<?php } ?>
							...
							<input type="hidden" name="prod_id" value="<?php echo $_GET['product_id']; ?>">
							 <button type="submit" name="add_variant_sunglasses" class="btn btn-inverse power_range_btn">Add Frame Colors</button>
						</form>
					</div>
