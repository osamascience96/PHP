...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
		...
		<a href="eye_care_cat.php" title="Eye Care" class="tip-bottom"><i class="icon-home"></i> Eye Care</a> <a href="#" class="current">Add Category </a> 
	  	<?php } else  if($_GET['type'] == "popular") {  ?>
		<a href="popular_eye_care.php" title="Popular Eye Care" class="tip-bottom"><i class="icon-home"></i> Popular Eye Care</a> <a href="#" class="current">Add Category </a> 
		<?php } else{} ?>
	  </div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions">
              <button type="submit" name="add_eye_care" class="btn btn-success" style="float:right;">Save</button>
            </div>
          </form>
        </div>
      </div>
	...
	<div class="widget-box" >
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions">
              <button type="submit" name="add_popular_eye_care" class="btn btn-success" style="float:right;">Save</button>
            </div>
          </form>
        </div>
      </div>
