...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="solutions.php" title="Go to Solutions" class="tip-bottom"><i class="icon-home"></i> Solutions</a> <a href="#" class="current">Edit Product </a> </div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions">
              <button type="submit" name="edit_solution" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
