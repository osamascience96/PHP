...
<div id="content">
    ...
    <div id="breadcrumb"> <a href="reglaze.php"  class="tip-bottom"><i class="icon-home"></i> Reglaze</a> <a href="#" class="current">Add Reglaze </a> </div>
    <h1>Add Reglaze <?php if(isset($_GET['product'])  == "contact_lense") { echo "Contact Lense"; } else{} ?></h1>
  </div>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions">
              <button type="submit" name="insert_reglaze" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
      </div>
