  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="index.html"> <i class="icon-dashboard"></i> <!--<span class="label label-important">20</span>--> Customers </a> </li>
        <li class="bg_lg span3"> <a href="orders.php"> <i class="icon-signal"></i> Orders</a> </li>
        <li class="bg_ly"> <a href="widgets.html"> <i class="icon-inbox"></i><!--<span class="label label-success">101</span>--> Offers </a> </li>
        <li class="bg_lo"> <a href="tables.html"> <i class="icon-th"></i> Users</a> </li>
		  
        <li class="bg_lr"> <a href="error404.html"> <i class="icon-info-sign"></i> Reviews</a> </li>
        <!--<li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Brands</a> </li>-->
        <li class="bg_lo span3"> <a href="form-common.html"> <i class="icon-th-list"></i> Products</a> </li>
        <li class="bg_ls"> <a href="buttons.html"> <i class="icon-tint"></i> Labs</a> </li>
        <li class="bg_lb"> <a href="interface.html"> <i class="icon-pencil"></i>Reglaze</a> </li>
        <li class="bg_lg"> <a href="calendar.html"> <i class="icon-calendar"></i> Postage</a> </li>
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="site-stats">
<br><br>
                <li class="bg_lh"><i class="icon-user"></i> <strong>2540</strong> <small>Orders</small></li>
                <li class="bg_lh"><i class="icon-plus"></i> <strong>120</strong> <small>Products </small></li>
                <li class="bg_lh"><i class="icon-shopping-cart"></i> <strong>656</strong> <small>Customers</small></li>
                <li class="bg_lh"><i class="icon-tag"></i> <strong>9540</strong> <small>Reviews</small></li>
              </ul>
            </div>
          </div>
        </div>
...
<!--End-Chart-box--> 
	...
	<div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-ok"></i></span>
            <h5>Product Upload Status</h5>
          </div>
          <div class="widget-content">
            <ul class="unstyled">
              <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span> Sunglasses <span class="pull-right strong">800</span>
                <div class="progress progress-striped ">
                  <div style="width: 81%;" class="bar"></div>
                </div>
              </li>
              <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span> Glasses <span class="pull-right strong">750</span>
                <div class="progress progress-success progress-striped ">
                  <div style="width: 72%;" class="bar"></div>
                </div>
              </li>
              <li> <span class="icon24 icomoon-icon-arrow-down-2 red"></span> Contact Lenses <span class="pull-right strong">565</span>
                <div class="progress progress-warning progress-striped ">
                  <div style="width: 53%;" class="bar"></div>
                </div>
              </li>
              <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span> Eye Care <span class="pull-right strong">323</span>
                <div class="progress progress-danger progress-striped ">
                  <div style="width: 30%;" class="bar"></div>
                </div>
              </li>
	      <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span> Solutions <span class="pull-right strong">500</span>
