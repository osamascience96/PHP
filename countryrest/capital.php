...
<div class="container">
    <!--  -->
    <form action="capital.php" method="POST" style='margin-top:10px;'>
        <div class="form-group">
            <label for="capital">Enter Capital City</label>
            <input id="capital" name="capital" type="text" class="form-control" placeholder="Capital City" required>
        </div>
        <div class="form-group">
        ...
        <?php if($_SERVER['REQUEST_METHOD'] == 'POST'){?>
            <?php if(isset($_POST['capital'])){?>
                <?php
                    ...
                    $url = "https://restcountries.eu/rest/v2/capital/".urlencode($_POST['capital']);
