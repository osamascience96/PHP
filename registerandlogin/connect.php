...
//The code above will connect to a MySQL database
//using the PDO extension. You will need to read
// the comments that are littered throughout the code
// and change the MySQL connection details
// to match your own!