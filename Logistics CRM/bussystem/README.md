...
The Application is now running on the custom build MVC Architecture. The htaccess files are the configuration files that builds this MVC Architecture. To know more about MVC Design Pattern, visit this **[link](https://www.tutorialspoint.com/design_pattern/mvc_pattern.htm)**

## Additional Vendor Changes

* Jquery Validation and Additional Script Files.

## Encryption

* For Encryption, md5 algorithm is used for the password
